...
class ApplicationColors {
  static const List<Color> gradientContainer = [
    Color(0xffe9def7),
    Color(0xffefe4e7),
    Color(0xfff0e5e5),
    Color(0xfff1e5e3),
  ];
  static const Color iconChevronColor = Color(0xff5e5d61);
  static const Color calenderColor = Color(0xff5b5a5c);
  static const Color searchIconColor = Color(0xff636162);
  static const Color textColor = Colors.black;
  static const Color moreHorizOutlinedColor = Color(0xffbbb6ac);
